...
- (void)viewDidLoad
{
    ...
    [_pageControl setBackgroundColor:[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.5]];
...
-(void) fillPages {
    for (int i=0; i<7; i++) {
        ...
        if(i==0) //Wat gaan we doen?
        {
            ...
            nameOfTool = [[UILabel alloc] initWithFrame:CGRectMake(130, 70, 160, 50)];
            nameOfTool.text = @"V60";
            ...
            timeLapse = [[UILabel alloc] initWithFrame:CGRectMake(130, 130, 160, 50)];
            timeLapse.text = @"2-3 Min doorlooptijd";
            ...
            imageOfToolView = [[UIView alloc] initWithFrame:CGRectMake(30, 130, 50, 50)];
            [imageOfToolView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"stopwatchicon.png"]]];
            
            videoTumbnail = [[UIView alloc] initWithFrame:CGRectMake(15, 240, 280, 158)];
        ...
        }else if(i==1) //Zet klaar
        {
            ...
            timeLapse = [[UILabel alloc] initWithFrame:CGRectMake(130, 135, 160, 50)];
            timeLapse.text = @"Een v60 met papieren filter";
            timeLapse.textColor = [UIColor blackColor];
            timeLapse.textAlignment = NSTextAlignmentLeft;
            timeLapse.font = [UIFont systemFontOfSize:12.0f];
            
            bonenNodig = [[UILabel alloc] initWithFrame:CGRectMake(130, 180, 160, 100)];
            bonenNodig.text = @"8 gram bonen";
            ...
            amountOfWater = [[UILabel alloc] initWithFrame:CGRectMake(130, 275, 320, 50)];
            amountOfWater.text = @"150 ML water 85-97 C";
        ...
        else if(i==6) //beoordelen
        {
            ...
            UILabel *opslaanButton = [[UILabel alloc] initWithFrame:CGRectMake(20, 400, 260, 50)];
            opslaanButton.backgroundColor = [UIColor clearColor];
            [opslaanButton setText:@"Geef mij advies"];
            [opslaanButton setTextColor:[UIColor blackColor]];
            [opslaanButton setTextAlignment:NSTextAlignmentCenter];
            
            UIButton *opslaanChecker = [[UIButton alloc] initWithFrame:CGRectMake(260, 415, 20, 20)];
            [opslaanChecker setBackgroundImage:[UIImage imageNamed:@"smallchecker.png"] forState:UIControlStateNormal];
...
-(void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component{
    ...
    if ([pickerView selectedRowInComponent:0] == 0) {
        [amountOfPeeps setText:@"1"];
        [bonenNodig setText:@"8 gram bonen"];
        amountOfWater.text = @"150 ML water 85-97 C";
        ...
        [amountOfPeeps setText:@"2"];
        [bonenNodig setText:@"16 gram bonen"];
        amountOfWater.text = @"300 ML water 85-97 C";
    }
    
    else  if ([pickerView selectedRowInComponent:0] == 2) {
        [amountOfPeeps setText:@"3"];
        [bonenNodig setText:@"24 gram bonen"];
        amountOfWater.text = @"450 ML water 85-97 C";
    }
